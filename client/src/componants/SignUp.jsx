...
const SignUpBuyer = ({ toggleBRegister, toggleBuyerLogin }) => {
    ...
    <div className="animation  z-20 fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center">
      <div className="bg-white p-5 border-gray-400 border-2 rounded-lg shadow-lg relative w-full max-w-md mx-4 transform transition-transform duration-500 ease-in-out scale-100">
        <div className="flex justify-between items-center">
          <p className="font-semibold mx-auto text-lg">Register/Sign in</p>
          <button className="animation text-black" onClick={toggleBRegister}>
            ✕
          </button>
        </div>
        ...
        <input
          ...
          <div className="mx-3 mt-4 text-center flex">
            <p>Already Have an Account?</p>
              <Link
              to={""}
              className="text-blue-500 ml-1"
              onClick={toggleBuyerLogin}
            >
              Login
            </Link>
          </div>
