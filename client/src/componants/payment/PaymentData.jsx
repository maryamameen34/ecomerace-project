...
const Payment = () => {
  ...
  const paypalPaymentHandler = async (paymentInfo) => {
    ...
    await axios
      .post(`http://locahost:8000/api/order/create-order`, order, config)
      .then((res) => {
        setOpen(false);
    ...
    try {
      ...
      if (result.error) {
        ...
        if (result.paymentIntent.status === "succeeded") {
          ...
          await axios
            .post(`http://localhost:8000/order/create-order`, order, config)
            .then((res) => {
              setOpen(false);
              navigate("/order/success");
              toast.success("Order successful!");
  ...
  const cashOnDeliveryHandler = async (e) => {
    ...
    await axios
    .post(`http://localhost:8000/api/order/create-order`, order, config)
    .then((res) => {
      setOpen(false);
      navigate("/order/success");
      toast.success("Order successful!");
