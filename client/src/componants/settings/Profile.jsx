...
import { loadLoggedinUser } from "../../redux/actions/user";
            ...
            <form onSubmit={handleSubmit} aria-required={true}>
              <div className="w-full 800px:flex block pb-3">
                ...
                <div className=" w-[100%] 800px:w-[50%]">
                  ...
                  <input
                    type="text"
                    className={`w-full border p-1 rounded-[5px] !w-[95%] mb-1 800px:mb-0`}
                    required
                    value={email}
...
const ChangePassword = () => {
  ...
  const passwordChangeHandler = async (e) => {
    ...
    await axios
      .put(
        `http://localhost:8000/user/update-user-password`,
